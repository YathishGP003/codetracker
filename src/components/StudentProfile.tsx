...
const StudentProfile: React.FC<StudentProfileProps> = ({
  ...
  const [activeTab, setActiveTab] = useState<"contests" | "problems">(
    "contests"
  );
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="space-y-8">
        ...
        >
          ...
          <div className="flex flex-col lg:flex-row lg:items-start lg:space-x-8 space-y-6 lg:space-y-0">
            ...
            <div className="flex-shrink-0">
              <div
                className={`w-24 h-24 rounded-3xl flex items-center justify-center text-2xl font-bold text-white mb-4 ${
                  student.isActive
        ...
        {/* Tab Navigation */}
        <div
          className={`rounded-3xl p-2 transition-all duration-500 ${
            isDarkMode
              ? "bg-slate-900/50 backdrop-blur-xl border border-slate-800/50"
              : "bg-white/80 backdrop-blur-xl border border-gray-200/50"
          }`}
        ...
        {/* Add Problem Statistics section */}
        <section>
          <ProblemStatistics />
        </section>
      </div>
